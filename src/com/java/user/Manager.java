...
public class Manager implements Auth {
	...
	public void register(FoodListImpl foodlist) {
		...
		System.out.print("등록하실 음식의 브랜드를 입력하세요 : ");
		brandName = scan.next();
	...
	public void edit(FoodListImpl foodlist) {
		...
		Scanner scan = new Scanner(System.in);
		String editName = null; // 수정 하고싶은 제품 이름
		String editPrice = null;
		String editWeight = null;

		System.out.print("수정하고 싶은 제품명을 입력하세요 : ");
		editName = scan.next();
	...
	public void delete(FoodListImpl foodlist) {
		Scanner scan = new Scanner(System.in);
		String delName = null;
		System.out.print("삭제하고 싶은 제품명을 입력하세요 : ");
		delName = scan.next();
		Food food = foodlist.getFood(delName);
		foodlist.delete(food);
	}
